...
int main()
{
    ...
    while (operacja != 'E') {
            ...
            if (wymiar == 'l')
            {
                ...
                for (int k = 0; k < rozmiar - 1; k++)
                {
                    if (macierz[k][k] == 0)
                    {
                        ...
                        if (j == rozmiar) //wyznacznik 0 bo brak wierszy do zmiany??
                        {
                            wyznacznik = 0;
                        }
                    }
        ...
        if (operacja == 'C') {
            ...
            //wypelnienie prostopaldoscianu szescianem
            ...
            //mniejszy od krawedzi wiekszy rowny 0
            for (int i = 0; i <= d; i++) {
                for (int j = 0; j <= h; j++) {
                    for (int k = 0; k <= w; k++) {
        ...
        if (operacja == 'O') {
            ...
            //to samo wypelnienie co wczesniej
            for (int i = 0; i < dlugoscKrawedzi; i++) {
                for (int j = 0; j < dlugoscKrawedzi; j++) {
                    for (int k = 0; k < dlugoscKrawedzi; k++) {
